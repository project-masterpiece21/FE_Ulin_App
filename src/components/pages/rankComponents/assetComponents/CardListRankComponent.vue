<template>
	<div class="w-full h-screen bg-white md:px-10 py-6 px-5 mt-20 rounded-lg">
		<div class="flex items-center justify-between pb-2 border-b">
			<div class="flex sm:flex-row flex-col truncate sm:text-base text-xs">
				<span>Peringkat menurut : </span> 
				<span class="font-bold truncate">pencarian</span>
			</div>
...
<script>
	...
	const CardItemRankComponent = defineAsyncComponent(() => import('./CardItemRankComponent.vue'));
	export default {
		components: {
			CardItemRankComponent
		}
