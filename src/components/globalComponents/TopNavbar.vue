<template>
  <header class="fixed top-0 2xl:container z-50 w-full md:bg-white bg-gray-100">
    <slot></slot>
      ...
      <div class="relative lg:block hidden w-3/5">
        <form class="relative w-full text-sm pb-5 overflow-hidden">
          <input
            ...
            name="search"
            class="
              focus:border-2 focus:border-yellow-500
              px-6
              focus:outline-none
              border
              py-2
              ...
              shadow
            "
            placeholder="Cari tempat destinasi wisata, tempat nongkrong, caffe"
          />
        ...
        <div
          ...
          "
        >
          <a href="/" class="mr-4 hover:text-yellow-600 truncate"
            >desa cibuntu</a
          >
          <a href="/" class="mr-4 hover:text-yellow-600 truncate"
            >taman kanggraksan</a
