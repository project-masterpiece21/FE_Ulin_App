<template>
	<div class="flex items-center">
		...
		<button class="hidden lg:block xl:mr-12 mr-5 px-6 xl:px-8 py-1.5 bg-gradient-to-r from-yellow-300 via-yellow-400 to-yellow-500 hover:bg-gradient-to-l hover:from-yellow-400 hover:to-yellow-400 transition duration-700 ease-in-out font-semibold text-white rounded-xl hover:shadow-md">
			Galery-ku
		</button>
		...
		<div class="flex items-center">
			...
			<router-link to="#">
				<button name="message" class="relative group h-9 w-9 md:h-10 md:w-10 rounded-full shadow focus:outline-none mr-2 bg-white">
					...
					<span class="iconify group-hover:text-yellow-500 text-sm md:text-lg text-yellow-500 mx-auto" data-icon="whh:notificationbottom" data-inline="false"></span>
				</button>
			</router-link>
